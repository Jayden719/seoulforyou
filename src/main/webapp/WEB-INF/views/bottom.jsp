...
<!-- 관리자 아이콘 -->	
	<c:choose>
     <c:when test="${not empty mdto or not empty adto}">
     <li></li>
	 </c:when>        
     <c:otherwise>
...
<!-- 트위터 아이콘 -->       
        <li class="ms-3"><a class="text-muted" href="https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoia28ifQ%3D%3D%22%7D">
        ...
        <li class="ms-3"><a class="text-muted" href="https://ko-kr.facebook.com">
